...
int main (int argc, char *argv[])
{
    ...
    while(avg_distance_moved > 1)
    {
        ...
        int* centroidSumX = malloc(n_centroids*sizeof(int));
        int* centroidSumY = malloc(n_centroids*sizeof(int));
        int* centroidCount = malloc(n_centroids*sizeof(int));

        memset(centroidSumX, 0, n_centroids*sizeof(int));
        memset(centroidSumY, 0, n_centroids*sizeof(int));
